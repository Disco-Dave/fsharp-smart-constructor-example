...
let private boundsAreValid (lowerBound : Bound<int>) (upperBound : Bound<int>) =
    Bound.value lowerBound <= Bound.value upperBound
...
let private valuesAboveUpperBound (lowerBound : Bound<int>) (upperBound : Bound<int>) (value : int) =
   boundsAreValid lowerBound upperBound &&
       ...
       | Exclusive bound -> value >= bound && Bound.value lowerBound <> bound
       | Inclusive bound -> value > bound && Bound.value lowerBound <> bound
...
[<Property>]
let ``value always returns the correct value for Inclusive`` (value : int) =
    let bound = Inclusive value
    Bound.value bound = value
    
[<Property>]
let ``value always returns the correct value for Exclusive`` (value : int) =
